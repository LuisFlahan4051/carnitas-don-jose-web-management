...
function AlertScreen(props: {darkTheme: boolean, type: string, msg: string, handlerAlert:any}) {
    ...
    return (
        <div className="AlertScreen" >
            ...
            <div className='alert__content' onClick={props.handlerAlert}>
                <div className={props.darkTheme ? 'alert__target-dark' : 'alert__target'}>
                    <img src={icon} alt="alert__icon" />
                    <p className='alert__msg'>
                      {props.msg}  
                    </p>
                    <button className='alert__ok' onClick={props.handlerAlert}>OK</button>        
                </div>            
            </div>
